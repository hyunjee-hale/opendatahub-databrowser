          ...
          properties: [
            {
              ...
              arrayMapping: {
                ...
                objectMapping: {
                  ...
                  Active: 'Active',
                  TagIds: 'TagIds',
                  SquareMeters: 'VenueRoomProperties.SquareMeters',
                  RoomWidthInMeters: 'VenueRoomProperties.RoomWidthInMeters',
                  RoomHeightInCentimeters: 'VenueRoomProperties.RoomHeightInCentimeters',
                  RoomDepthInMeters: 'VenueRoomProperties.RoomDepthInMeters',
                  DoorWidthInCentimeters: 'VenueRoomProperties.DoorWidthInCentimeters',
                  DoorHeightInCentimeters: 'VenueRoomProperties.DoorHeightInCentimeters',
                },
